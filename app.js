...
const purchaseRequisitionRoutes = require('./warehouse/routes/purchaseRequisitionRoutes');
...
const purchaseRefundRoutes = require('./warehouse/routes/purchaseRefundRoutes');
...
app.use('/api/purchase/refunds', purchaseRefundRoutes);
...
app.use('/api/admin', companyStorageRoutes);
